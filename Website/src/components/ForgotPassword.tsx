  ...
  return (
    <main className="recovery-page">
      <section className="recovery-shell">
        <aside className="recovery-promo">
          <span className="security-chip">
            <i /> HỆ THỐNG BẢO MẬT TÀI KHOẢN HỘI VIÊN
          </span>
          <div className="recovery-copy">
            <div className="shield">♢</div>
            <h1>
              QA-GYM <em>ACCESS KEY</em>
            </h1>
            <p>
              Bảo vệ dữ liệu luyện tập và sinh trắc học InBody, và quyền truy
              cập phòng tập thông minh 24/7 của bạn với giao thức mã hóa kép.
            </p>
            <div className="security-stats">
              <article>
                <i>◉</i>
                <span>
                  OTP EXPIRY<b>05:00</b>
                  <small>Tự động hủy phiên</small>
                </span>
              </article>
              <article>
                <i>♢</i>
          ...
          <div className="club-preview">
            <div>
              <b>STRENGTH / ENDURANCE FLOOR</b>
              <strong>TRẠM TIẾP NHẬN HỘI VIÊN</strong>
            </div>
            <span>↗</span>
          </div>
          <footer className="help-desk">
            <i>♙</i>
            <span>
              HỖ TRỢ KỸ THUẬT LỄ TÂN<b>1900 8899</b>
            </span>
            <strong>24/7 DESK</strong>
          </footer>
        </aside>
          ...
          <form onSubmit={submit}>
            <div className="recovery-steps">
              <span className="active">
                <b>1</b>
                <i>BƯỚC 1</i>Nhập thông tin
              </span>
              <span>
                <b>2</b>
                <i>BƯỚC 2</i>Mã OTP 6 số
              </span>
              <span>
                <b>3</b>
                <i>BƯỚC 3</i>Đặt mật khẩu
              </span>
            </div>
            <div className="recovery-heading">
              <span>◉　XÁC THỰC THÀNH VIÊN</span>
              <h2>KHÔI PHỤC MẬT KHẨU</h2>
              <p>
                Vui lòng nhập Email hoặc Số điện thoại đã đăng ký với QA-Gym để
                nhận mã xác minh OTP đặt lại mật khẩu của bạn.
              </p>
            </div>
            ...
            <footer className="recovery-footer">
              <button type="button" onClick={onBack}>
                ←　Quay lại Đăng nhập QA-Gym
              </button>
              <span>●　Bảo mật thiết bị đạt chuẩn ISO 27001</span>
            </footer>
          </form>
        </section>
      </section>
