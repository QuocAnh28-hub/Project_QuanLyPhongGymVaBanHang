...
const styles = StyleSheet.create({
  ...
  brandBlock: { flexShrink: 1, paddingRight: 76 }, headerActions: { position: 'absolute', top: 8.5, right: 0, flexDirection: 'row', alignItems: 'center', gap: 14 }, 
  ...
  brandWrap: { flexDirection: 'row', alignItems: 'center', gap: 7 }, brandMark: { width: 25, height: 25, backgroundColor: '#1b2021', justifyContent: 'center', alignItems: 'center' }, 
  brand: { color: '#f3f5ec', fontSize: 21, fontWeight: '900', letterSpacing: 1.2 }, brandSub: { color: '#d9ff00', fontSize: 7, fontWeight: '900', letterSpacing: 1 }, 
  avatar: { width: 30, height: 30, borderRadius: 15, backgroundColor: '#6b7c61', justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#b4c7a7' }, 
  avatarText: { color: '#f5f9ed', fontWeight: '800' },
  intro: { alignItems: 'center', paddingTop: 22, paddingBottom: 17 }, eyebrow: { backgroundColor: '#253500', borderRadius: 8, paddingHorizontal: 8, paddingVertical: 5 }, 
  eyebrowText: { color: '#cbed00', fontSize: 7, fontWeight: '900' }, title: { color: '#e5e9e3', textAlign: 'center', fontSize: 18, lineHeight: 21, fontWeight: '900', marginTop: 10 }, 
  subtitle: { color: '#879087', textAlign: 'center', fontSize: 10, lineHeight: 14, marginTop: 8 },
  durationBar: { flexDirection: 'row', backgroundColor: '#1a1e20', borderRadius: 7, padding: 3, marginBottom: 18 }, durationItem: { flex: 1, minHeight: 38, justifyContent: 'center', 
  alignItems: 'center', borderRadius: 5 }, durationSelected: { backgroundColor: '#d9ff00' }, durationText: { color: '#c3c9c0', fontSize: 8, fontWeight: '800' }, 
  durationSelectedText: { color: '#1d2700' }, hotBadge: { color: '#fff', backgroundColor: '#e80038', fontSize: 6, fontWeight: '900', paddingHorizontal: 4, paddingVertical: 2, borderRadius: 4, marginTop: 2 },
  planCard: { backgroundColor: '#202427', borderRadius: 8, padding: 11, marginBottom: 10, borderWidth: 1, borderColor: '#2c3133' }, 
  planTag: { alignSelf: 'flex-start', backgroundColor: '#c9f000', borderRadius: 5, paddingHorizontal: 6, paddingVertical: 4 }, planTagText: { color: '#263100', fontSize: 7, fontWeight: '900' }, planKicker: { color: '#cbed00', fontSize: 7, fontWeight: '900', marginTop: 9 }, 
  planHeadingRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' }, planName: { color: '#e5e8e3', fontSize: 14, fontWeight: '900', marginTop: 3 }, priceRow: { flexDirection: 'row', alignItems: 'baseline', marginTop: 2 }, 
  price: { color: '#d9ff00', fontSize: 27, lineHeight: 30, fontWeight: '900' }, darkPrice: { color: '#e0e4df', fontSize: 27, lineHeight: 30, fontWeight: '900' }, perMonth: { color: '#88908b', fontSize: 8, marginLeft: 3 }, planStar: { color: '#d9ff00', fontSize: 25 }, 
  saving: { color: '#bbdb00', fontSize: 8, fontWeight: '700', marginTop: 3 }, benefits: { marginTop: 9, gap: 5 }, benefitRow: { flexDirection: 'row', alignItems: 'flex-start', backgroundColor: '#171a1c', borderRadius: 4, paddingVertical: 7, paddingHorizontal: 7 }, 
  benefitIcon: { color: '#cfff00', width: 16, fontSize: 11, fontWeight: '900' }, benefitText: { color: '#c4c9c4', flex: 1, fontSize: 9, lineHeight: 12 }, planButton: { backgroundColor: '#caff00', minHeight: 29, borderRadius: 5, justifyContent: 'center', alignItems: 'center', marginTop: 10, flexDirection: 'row' }, 
  planButtonText: { color: '#1b2600', fontSize: 9, fontWeight: '900' }, buttonArrow: { color: '#1b2600', fontSize: 11, marginLeft: 5 }, mutedButton: { backgroundColor: '#3b3e42' }, mutedButtonText: { color: '#e1e4df' }, hotline: { color: '#9ca49b', fontSize: 8, textAlign: 'center', marginTop: 8 },
  blueTag: { backgroundColor: '#182e3b' }, blueTagText: { color: '#59c8f1' }, blueKicker: { color: '#4ebbe6' }, diamond: { color: '#63cfff', fontSize: 28 }, 
  silverTag: { backgroundColor: '#39413e' }, silverTagText: { color: '#d1d7ce' }, studentCard: { backgroundColor: '#1c2022', borderRadius: 8, padding: 11, marginBottom: 20, flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', gap: 6 }, 
  studentTag: { backgroundColor: '#0ba879' }, studentTagText: { color: '#071c17' }, studentCopy: { color: '#8b948e', fontSize: 8, lineHeight: 11, marginTop: 5 }, studentPrice: { alignItems: 'flex-end' }, 
  studentAmount: { color: '#50d9a9', fontSize: 15, fontWeight: '900', marginTop: 15 }, studentTime: { color: '#9fa9a1', fontSize: 8, marginTop: 14 },
  tableTitle: { color: '#cbed00', textAlign: 'center', fontSize: 7, fontWeight: '900', letterSpacing: 1, marginBottom: 4 }, tableHeading: { color: '#e5e9e4', textAlign: 'center', fontSize: 13, fontWeight: '900', marginBottom: 9 }, 
  table: { backgroundColor: '#1c2022', borderRadius: 7, overflow: 'hidden', marginBottom: 14 }, tableRow: { flexDirection: 'row', minHeight: 31, alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#2d3234' }, 
  tableCell: { color: '#a8b0a9', fontSize: 7, flex: 1, textAlign: 'center' }, tableLabel: { color: '#d7dbd6', textAlign: 'left', paddingLeft: 6, flex: 1.3 }, tableAccent: { color: '#cbed00', fontWeight: '800' }, 
  noteCard: { flexDirection: 'row', backgroundColor: '#292d30', borderRadius: 8, padding: 11, marginBottom: 9 }, noteIcon: { color: '#cbed00', fontSize: 17, width: 28 }, noteTitle: { color: '#e0e5df', fontSize: 10, fontWeight: '800' }, 
  noteText: { color: '#a4aca5', fontSize: 8, lineHeight: 11, marginTop: 4 }, footerPromo: { minHeight: 190, justifyContent: 'flex-end', padding: 12, marginTop: 10, backgroundColor: '#15191a', borderRadius: 6 }, promoKicker: { color: '#cbed00', fontSize: 7, fontWeight: '900' }, 
  promoTitle: { color: '#e5ebe4', fontSize: 14, lineHeight: 17, fontWeight: '900', marginTop: 5 }, promoCopy: { color: '#c0c6bf', fontSize: 9, textAlign: 'center', marginTop: 30 }, promoLink: { color: '#cbed00', fontSize: 8, textAlign: 'center', fontWeight: '900', marginTop: 10 },
});