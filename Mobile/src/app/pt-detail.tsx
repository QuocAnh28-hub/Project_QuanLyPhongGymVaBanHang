...
const styles = StyleSheet.create({
  ...
  role: { color: "#d9ff00", fontSize: 7, fontWeight: "900" },
  name: { color: "#f2f7ec", fontSize: 19, fontWeight: "900", marginTop: 3 },
  ...
  statValue: { color: "#d9ff00", fontSize: 14, fontWeight: "900" },
  statLabel: {
    color: "#e4ece1",
    fontSize: 6,
    textAlign: "center",
  ...
  statDetail: { color: "#8d998e", fontSize: 6, marginTop: 3 },
  titleRow: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  sectionTitle: { color: "#e7eee3", fontSize: 8, fontWeight: "900" },
  action: { color: "#d9ff00", fontSize: 6, fontWeight: "900" },
  ...
  bioText: { color: "#b5c0b3", fontSize: 8, lineHeight: 13 },
  specialty: { color: "#d9ff00", fontSize: 7, lineHeight: 11, marginTop: 8 },
  package: {
    backgroundColor: "#1b2022",
    borderRadius: 7,
    padding: 10,
  ...
  packageName: { color: "#edf2e8", fontSize: 9, fontWeight: "900" },
  packagePrice: { color: "#d9ff00", fontSize: 11, fontWeight: "900" },
  packageDetail: { color: "#9da89d", fontSize: 7, marginTop: 5 },
  packageMeta: { color: "#c8d500", fontSize: 6, marginTop: 6 },
  schedule: { backgroundColor: "#1b2022", borderRadius: 7, padding: 10 },
  scheduleRow: { color: "#aeb9ad", fontSize: 7, lineHeight: 20 },
  bottomBar: {
  ...
  bottomLabel: { color: "#96a095", fontSize: 6, fontWeight: "900" },
  bottomPrice: { color: "#d9ff00", fontSize: 17, fontWeight: "900" },
  per: { color: "#aeb9ad", fontSize: 7 },
  bookButton: {
    height: 39,
    borderRadius: 7,
  ...
  bookText: { color: "#182000", fontSize: 7, fontWeight: "900" },
});
