  ...
  return (
    <View style={styles.workoutCard}>
      ...
      <View style={styles.workoutTag}>
        <Text style={styles.workoutTagText}>{tag}</Text>
      </View>
      ...
      <SafeAreaView edges={["top"]} style={styles.safeArea}>
        ...
        >
          ...
          <View style={styles.greeting}>
            ...
            <Text style={styles.greetingTitle}>Sẵn sàng bứt phá?</Text>
            <Text style={styles.greetingCopy}>
              Hôm nay là một ngày tuyệt vời để chăm sóc cơ thể.
            </Text>
          </View>
          ...
          <View style={styles.heroCard}>
            ...
            <View style={styles.heroCopy}>
              <View style={styles.pill}>
                <Text style={styles.pillText}>✦ ƯU ĐÃI ĐẶC BIỆT</Text>
              </View>
          ...
          >
            <WorkoutCard
              image={images.hiit}
              title="Cardio Hi-Tech Zone"
              detail="Máy chạy bộ và thiết bị tập tim mạch"
              tag="NHIỆT ĐỘ 24°C"
            />
            <WorkoutCard
              image={images.strength}
              title="Free Weights"
              detail="Khu vực tạ tự do chuyên nghiệp"
              tag="TẦNG 2"
            />
            <WorkoutCard
              image={images.yoga}
              title="Mind & Body"
              detail="Yoga, stretching và thiền"
              tag="YÊN TĨNH"
            />
          </ScrollView>
          ...
          <Text style={styles.footerNote}>
            ⌁ Áp dụng cho hội viên mới • Điều kiện áp dụng
          </Text>
        </ScrollView>
      </SafeAreaView>
    </View>
...
const styles = StyleSheet.create({
  ...
  greetingCopy: { color: "#9ca599", fontSize: 12, marginTop: 6 },
  heroCard: {
    height: 204,
    borderRadius: 14,
    overflow: "hidden",
  ...
  pillText: { color: "#192000", fontSize: 9, fontWeight: "900" },
  heroTitle: { color: "#fff", fontSize: 24, fontWeight: "900", lineHeight: 26 },
  heroDetail: { color: "#d4dbcf", fontSize: 11, marginTop: 7 },
  heroButton: {
  ...
  heroButtonText: { color: "#152000", fontSize: 10, fontWeight: "900" },
  sectionTitle: {
    flexDirection: "row",
  ...
  sectionHeading: { color: "#f2f6ea", fontSize: 15, fontWeight: "800" },
  sectionAction: { color: "#c9ed00", fontSize: 9, fontWeight: "900" },
  statsGrid: {
    flexDirection: "row",
    flexWrap: "wrap",
    gap: 6,
  ...
  statIcon: { fontSize: 16, fontWeight: "900", marginBottom: 4 },
  statValue: { color: "#f0f4e8", fontSize: 12, fontWeight: "800" },
  statLabel: { color: "#8e978d", fontSize: 9, marginTop: 3 },
  ...
  workoutTagText: { color: "#172000", fontSize: 7, fontWeight: "900" },
  workoutCopy: { position: "absolute", left: 12, right: 10, bottom: 11 },
  workoutTitle: { color: "#fff", fontSize: 14, fontWeight: "900" },
  workoutDetail: {
    color: "#d0d8ce",
    fontSize: 9,
    marginTop: 4,
  ...
  scheduleInfo: { flex: 1 },
  scheduleTitle: { color: "#ecf2e7", fontSize: 11, fontWeight: "800" },
  scheduleRoom: { color: "#858e84", fontSize: 9, marginTop: 4 },
  seatPill: {
  ...
  seatText: { color: "#bde000", fontSize: 8, fontWeight: "800" },
  reviewCard: {
    backgroundColor: "#1d231e",
    borderRadius: 9,
    padding: 14,
  ...
  stars: { color: "#d9ff00", fontSize: 13, letterSpacing: 1 },
  rating: { color: "#e8eee2", fontSize: 11, letterSpacing: 0 },
  reviewQuote: { color: "#d9ded5", fontSize: 11, lineHeight: 17, marginTop: 8 },
  reviewAuthor: { color: "#899288", fontSize: 9, marginTop: 7 },
  ctaCard: {
  ...
  ctaIcon: { color: "#d9ff00", fontSize: 22, marginBottom: 8 },
  ctaKicker: {
    color: "#b8cf00",
    fontSize: 8,
    fontWeight: "900",
  ...
  ctaButtonText: { color: "#192100", fontSize: 9, fontWeight: "900" },
  footerNote: {
    color: "#717a6e",
    fontSize: 8,
    textAlign: "center",
