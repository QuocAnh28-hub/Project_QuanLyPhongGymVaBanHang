...
const styles = StyleSheet.create({
  ...
  topTitle: { color: "#e8eee4", fontSize: 10, fontWeight: "900" },
  account: {
    width: 25,
    height: 25,
    borderRadius: 13,
  ...
  stepIconText: { color: "#7b857c", fontSize: 8, fontWeight: "900" },
  ...
  modeActiveText: { color: "#182000", fontSize: 7, fontWeight: "900" },
  modeText: { color: "#d9ff00", fontSize: 7, fontWeight: "900" },
  sectionHeader: {
    flexDirection: "row",
    alignItems: "center",
    gap: 7,
  ...
  sectionTitle: { color: "#e7eee3", fontSize: 10, fontWeight: "900", flex: 1 },
  sectionAction: { color: "#bed500", fontSize: 7, fontWeight: "900" },
  ...
  phone: { color: "#c6d2c2", fontSize: 7, lineHeight: 10, width: 50 },
  addressTag: {
    color: "#d9ff00",
  ...
  address: { color: "#a6b0a4", fontSize: 8, lineHeight: 12, marginTop: 5 },
  ...
  productName: { color: "#e8eee4", fontSize: 8, fontWeight: "900" },
  productDetail: { color: "#89948b", fontSize: 7, marginTop: 3 },
  productPrice: {
    color: "#e9f1e5",
    fontSize: 11,
    fontWeight: "900",
  ...
  choiceTitle: { color: "#e1e9df", fontSize: 8, fontWeight: "900" },
  choiceDetail: { color: "#89948b", fontSize: 7, marginTop: 3 },
  ...
  paymentTitle: { color: "#e5ede2", fontSize: 8, fontWeight: "900" },
  paymentDetail: { color: "#89948b", fontSize: 7, marginTop: 3 },
  pointsHint: { color: "#49d69d", fontSize: 6, marginTop: 3 },
  pointsCard: {
    backgroundColor: "#1b2022",
    borderRadius: 7,
    padding: 9,
  ...
  pointsTitle: { color: "#e8eee4", fontSize: 10, fontWeight: "900" },
  pointsBadge: {
    color: "#182000",
  ...
  pointsDetail: { color: "#89948b", fontSize: 7, marginTop: 3 },
  toggle: {
    width: 33,
    height: 18,
    borderRadius: 10,
  ...
  summaryTitle: { color: "#e8eee4", fontSize: 10, fontWeight: "900" },
  vat: { color: "#b7c500", fontSize: 7, fontWeight: "900" },
  summaryRow: {
    flexDirection: "row",
    justifyContent: "space-between",
    paddingVertical: 4,
  },
  summaryLabel: { color: "#b3bdb2", fontSize: 8 },
  summaryValue: { color: "#e5ede2", fontSize: 8, fontWeight: "800" },
  grandTotal: {
    borderTopWidth: 1,
  ...
  grandLabel: { color: "#eaf0e6", fontSize: 10, fontWeight: "900" },
  grandValue: {
    color: "#d9ff00",
    fontSize: 20,
    fontWeight: "900",
  ...
  bottomLabel: { color: "#89938a", fontSize: 6, fontWeight: "900" },
  ...
  secureText: { color: "#9ba692", fontSize: 6 },
  orderButton: {
    height: 38,
    marginTop: 5,
    borderRadius: 7,
  ...
  orderText: { color: "#182000", fontSize: 9, fontWeight: "900" },
});
