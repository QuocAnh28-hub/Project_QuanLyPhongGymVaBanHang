...
const styles = StyleSheet.create({
  ...
  topBarTitle: { color: "#e7eee5", fontSize: 12, fontWeight: "900" },
  accountButton: {
    width: 25,
    height: 25,
    borderRadius: 13,
  ...
  heading: { color: "#eef3e9", fontSize: 12, fontWeight: "900" },
  itemCount: { color: "#d9ff00", fontSize: 8 },
  clearText: { color: "#bbc500", fontSize: 8, fontWeight: "800" },
  shippingCard: {
  ...
  shippingTitle: { color: "#e9f0e6", fontSize: 9, fontWeight: "900", flex: 1 },
  shippingPercent: { color: "#d9ff00", fontSize: 8, fontWeight: "900" },
  shippingCopy: { color: "#bac2b8", fontSize: 8, marginTop: 7 },
  ...
  itemName: { color: "#e9eee7", fontSize: 10, fontWeight: "900" },
  itemDetail: { color: "#95a095", fontSize: 7, marginTop: 4 },
  itemPriceRow: { flexDirection: "row", alignItems: "center", marginTop: 5 },
  itemPrice: { color: "#d9ff00", fontSize: 11, fontWeight: "900" },
  itemOldPrice: {
    color: "#717a72",
    fontSize: 7,
  ...
  remove: { color: "#c4d400", fontSize: 19, lineHeight: 19, marginLeft: 6 },
  itemBottom: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
  ...
  stock: { color: "#45d49e", fontSize: 7, fontWeight: "900" },
  quantity: {
    width: 67,
    height: 27,
    flexDirection: "row",
  ...
  quantityAction: { color: "#d9ff00", fontSize: 15, paddingHorizontal: 5 },
  quantityValue: { color: "#f0f5eb", fontSize: 9, fontWeight: "900" },
  giftCard: {
    backgroundColor: "#1b2022",
    borderRadius: 8,
    padding: 9,
  ...
  giftTitle: { color: "#d9ff00", fontSize: 8, fontWeight: "900", flex: 1 },
  giftBadge: {
    color: "#253000",
    backgroundColor: "#d9ff00",
    fontSize: 6,
  ...
  giftName: { color: "#e7eee4", fontSize: 8, fontWeight: "900" },
  giftDetail: { color: "#9ca69b", fontSize: 7, marginTop: 3 },
  giftPrice: { color: "#d9ff00", fontSize: 7, fontWeight: "900", marginTop: 3 },
  giftOldPrice: {
    color: "#879085",
    textDecorationLine: "line-through",
    fontWeight: "400",
  ...
  couponTitle: { color: "#e7eee4", fontSize: 8, fontWeight: "900" },
  ...
  applyText: { color: "#192100", fontSize: 8, fontWeight: "900" },
  appliedCoupon: {
  ...
  appliedText: { color: "#d9ff00", fontSize: 8, fontWeight: "900", flex: 1 },
  ...
  summaryLabel: { color: "#bdc6ba", fontSize: 8 },
  summaryValue: { color: "#e2e9df", fontSize: 8, fontWeight: "800" },
  ...
  totalLabel: { color: "#edf2e9", fontSize: 9, fontWeight: "900" },
  totalValue: { color: "#d9ff00", fontSize: 16, fontWeight: "900" },
  tax: { color: "#9ba59a", fontSize: 7, textAlign: "right", marginTop: 2 },
  bottomBar: {
    minHeight: 62,
    flexDirection: "row",
    alignItems: "center",
  ...
  bottomLabel: { color: "#89938a", fontSize: 7 },
  bottomTotal: { color: "#d9ff00", fontSize: 16, fontWeight: "900" },
  saved: { color: "#8c978c", fontSize: 6 },
  checkoutButton: {
    height: 39,
    minWidth: 137,
    flexDirection: "row",
  ...
  checkoutText: { color: "#1b2400", fontSize: 8, fontWeight: "900" },
});
