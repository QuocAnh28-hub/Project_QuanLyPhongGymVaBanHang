...
const styles = StyleSheet.create({
  ...
  categoryText: { color: "#bdc5b8", fontSize: 9, fontWeight: "800" },
  ...
  promoCopy: { flex: 1 },
  promoTitle: { color: "#d9ff00", fontSize: 8, fontWeight: "900" },
  promoDiscount: {
    color: "#d9ff00",
  ...
  sectionTitle: { color: "#eff4e9", fontSize: 15, fontWeight: "900" },
  countBadge: {
    color: "#b8c0b3",
  ...
  favoriteText: { color: "#e6eee2", fontSize: 20, lineHeight: 22 },
  ...
  productDetail: { color: "#8e998d", fontSize: 8, marginTop: 4 },
  oldPrice: {
    color: "#6c756d",
    fontSize: 8,
  ...
  productPrice: { color: "#d9ff00", fontSize: 15, fontWeight: "900" },
  addButton: {
    width: 30,
    height: 30,
    borderRadius: 9,
  ...
  helpCopy: { flex: 1 },
  helpTitle: { color: "#e8eee3", fontSize: 11, fontWeight: "800" },
  helpText: { color: "#8f998e", fontSize: 8, marginTop: 4 },
  helpButton: {
