    ...
    <SafeAreaView edges={['top']} style={styles.safeArea}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <View style={styles.searchRow}>
          ...
          <Pressable style={styles.cartButton} accessibilityLabel="Giỏ hàng"><FontAwesome name="shopping-cart" size={18} color="#e4e9df" /><Text style={styles.cartBadge}>2</Text></Pressable>
        </View>
        ...
        <View style={styles.productGrid}>{products.map((product) => <ProductCard key={product[0]} product={product} />)}</View>
...
const styles = StyleSheet.create({
  ...
  filterButton: { width: 44, height: 42, borderRadius: 9, backgroundColor: '#292d30', justifyContent: 'center', alignItems: 'center' }, filterDot: { position: 'absolute', top: 8, right: 9, width: 6, height: 6, borderRadius: 3, backgroundColor: '#d9ff00' }, 
  cartButton: { width: 44, height: 42, borderRadius: 9, backgroundColor: '#292d30', justifyContent: 'center', alignItems: 'center' }, cartBadge: { position: 'absolute', top: -5, right: -4, minWidth: 17, height: 17, borderRadius: 9, backgroundColor: '#d9ff00', color: '#182000', fontSize: 9, fontWeight: '900', textAlign: 'center', paddingTop: 3 },
  categoryList: { gap: 7, paddingBottom: 18 }, categoryChip: { backgroundColor: '#1d211e', borderRadius: 15, paddingHorizontal: 13, paddingVertical: 8 }, categoryChipActive: { backgroundColor: '#d9ff00' }, categoryText: { color: '#bdc5b8', fontSize: 9, fontWeight: '800' }, 
  categoryTextActive: { color: '#172000' }, promoCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#272c27', borderRadius: 9, padding: 11, marginBottom: 22 }, promoIcon: { width: 34, height: 34, borderRadius: 17, backgroundColor: '#1d241d', alignItems: 'center', justifyContent: 'center', marginRight: 10 }, promoCopy: { flex: 1 }, 
  ...
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 11 }, sectionTitle: { color: '#eff4e9', fontSize: 15, fontWeight: '900' }, countBadge: { color: '#b8c0b3', backgroundColor: '#303631', fontSize: 9, paddingHorizontal: 5, borderRadius: 7 }, sortText: { color: '#9ba59a', fontSize: 9 }, 
  productGrid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', rowGap: 10 }, productCard: { width: '48.6%', backgroundColor: '#1d211f', borderRadius: 10, overflow: 'hidden' }, productImageWrap: { height: 142, backgroundColor: '#252a26', position: 'relative' }, productImage: { width: '100%', height: '100%' }, 
  productBadge: { position: 'absolute', top: 8, left: 8, color: '#182000', backgroundColor: '#caff00', borderRadius: 3, paddingHorizontal: 5, paddingVertical: 4, fontSize: 7, fontWeight: '900' }, favorite: { position: 'absolute', top: 7, right: 7, width: 25, height: 25, borderRadius: 13, backgroundColor: 'rgba(16, 18, 16, .72)', alignItems: 'center', justifyContent: 'center' }, 
  favoriteText: { color: '#e6eee2', fontSize: 20, lineHeight: 22 }, productInfo: { padding: 9 }, rating: { color: '#d9ff00', fontSize: 9, fontWeight: '800' }, reviewCount: { color: '#8e998d', fontWeight: '400' }, productName: { color: '#edf2e8', fontSize: 11, lineHeight: 14, fontWeight: '800', marginTop: 7, minHeight: 28 }, productDetail: { color: '#8e998d', fontSize: 8, marginTop: 4 }, 
  oldPrice: { color: '#6c756d', fontSize: 8, textDecorationLine: 'line-through', marginTop: 5 }, 
  priceRow: { minHeight: 31, flexDirection: 'row', alignItems: 'flex-end', marginTop: 2 }, productPrice: { color: '#d9ff00', fontSize: 15, fontWeight: '900' }, addButton: { width: 30, height: 30, borderRadius: 9, backgroundColor: '#caff00', alignItems: 'center', justifyContent: 'center', marginLeft: 'auto' }, addButtonText: { color: '#1b2600', fontSize: 23, lineHeight: 25, fontWeight: '500' },
  helpCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#252a27', borderRadius: 10, padding: 12, marginTop: 22 }, helpIcon: { width: 32, height: 32, borderRadius: 16, backgroundColor: '#303930', alignItems: 'center', justifyContent: 'center', marginRight: 9 }, helpCopy: { flex: 1 }, helpTitle: { color: '#e8eee3', fontSize: 11, fontWeight: '800' }, 
  helpText: { color: '#8f998e', fontSize: 8, marginTop: 4 }, helpButton: { backgroundColor: '#383d3b', borderRadius: 6, paddingHorizontal: 10, paddingVertical: 8 }, helpButtonText: { color: '#e2e9df', fontSize: 8, fontWeight: '800', textAlign: 'center' },
});
