...
const styles = StyleSheet.create({
  ...
  supportText: { color: "#d9ff00", fontSize: 7, fontWeight: "900" },
  supportPhone: {
    color: "#d9ff00",
  ...
  stepNumberText: { color: "#89938a", fontSize: 10, fontWeight: "900" },
  stepNumberTextActive: { color: "#182000" },
  stepLabel: { color: "#8c978e", fontSize: 7, marginTop: 3 },
  ...
  trainerName: { color: "#f0f5eb", fontSize: 11, fontWeight: "900" },
  trainerRole: {
    color: "#d9ff00",
    fontSize: 7,
    fontWeight: "900",
  ...
  trainerLocation: { color: "#a6b2a5", fontSize: 7, marginTop: 5 },
  sectionTitleRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 6,
  ...
  sectionTitle: { color: "#eaf0e6", fontSize: 11, fontWeight: "900", flex: 1 },
  ...
  packageName: { color: "#eef4e8", fontSize: 10, fontWeight: "900" },
  packageDetail: { color: "#9ba69d", fontSize: 8, marginTop: 4 },
  packageBonus: { color: "#d9ff00", fontSize: 7, marginTop: 5 },
  ...
  goalText: { color: "#d4ddd3", fontSize: 7, fontWeight: "800" },
  ...
  dateDay: { color: "#b5c0b5", fontSize: 7, fontWeight: "900" },
  dateNumber: {
    color: "#e8eee4",
    fontSize: 14,
    fontWeight: "900",
  ...
  timeText: { color: "#dae2d8", fontSize: 8, fontWeight: "900" },
  timeActiveText: { color: "#182000" },
  voucher: { backgroundColor: "#1b2022", borderRadius: 7, padding: 10 },
  voucherCode: { color: "#d9ff00", fontSize: 10, fontWeight: "900" },
  voucherButton: {
    position: "absolute",
    right: 10,
    top: 9,
  ...
  voucherDetail: { color: "#aeb9ad", fontSize: 8, marginTop: 7 },
  points: { color: "#d9ff00", fontSize: 8, marginTop: 6 },
  paymentPanel: {
    backgroundColor: "#1b2022",
    borderRadius: 7,
    paddingHorizontal: 9,
  ...
  paymentName: { color: "#e5ede2", fontSize: 9, fontWeight: "900" },
  ...
  summaryLine: { color: "#aeb9ad", fontSize: 8, marginBottom: 5 },
  accent: { color: "#d9ff00" },
  summaryTotal: {
    borderTopWidth: 1,
  ...
  summaryTitle: { color: "#e9f0e5", fontSize: 11, fontWeight: "900" },
  summaryPrice: { color: "#d9ff00", fontSize: 17, fontWeight: "900" },
  promise: {
    flexDirection: "row",
    gap: 8,
    backgroundColor: "#1b2022",
  ...
  promiseText: { color: "#aeb9ad", flex: 1, fontSize: 8, lineHeight: 11 },
  ...
  bottomLabel: { color: "#9da89d", fontSize: 7, fontWeight: "900" },
  bottomPrice: { color: "#d9ff00", fontSize: 18, fontWeight: "900" },
  bottomHint: { color: "#849085", fontSize: 7, marginTop: 2 },
  confirmButton: {
    height: 39,
    borderRadius: 7,
    backgroundColor: "#caff00",
  ...
  confirmText: { color: "#182000", fontSize: 8, fontWeight: "900" },
});
