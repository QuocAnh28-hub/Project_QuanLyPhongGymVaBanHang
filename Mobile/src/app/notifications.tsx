...
const s = StyleSheet.create({
  ...
  headerTitle: { color: C.text, flex: 1, fontSize: 15, fontWeight: "900" },
  list: {
    width: "100%",
    maxWidth: 540,
    alignSelf: "center",
  ...
  summaryDetail: { color: C.muted, fontSize: 11, marginTop: 5 },
  ...
  section: { color: C.text, fontSize: 11, fontWeight: "900", flex: 1 },
  sortButton: {
    minHeight: 44,
    flexDirection: "row",
    alignItems: "center",
  ...
  sortText: { color: C.lime, fontSize: 10, fontWeight: "900" },
  error: { color: C.error, fontSize: 12, marginBottom: 10 },
  card: {
    flexDirection: "row",
    gap: 10,
    backgroundColor: C.surface,
  ...
  time: { color: C.muted, fontSize: 10, marginTop: 5 },
  message: { color: C.muted, fontSize: 12, lineHeight: 16, marginTop: 7 },
  actionButton: {
    minHeight: 44,
    flexDirection: "row",
    alignItems: "center",
  ...
  actionText: { color: C.lime, fontSize: 11, fontWeight: "900" },
  empty: {
    minHeight: 220,
    justifyContent: "center",
    alignItems: "center",
  ...
  loadMoreText: { color: C.text, fontSize: 11, fontWeight: "800" },
  backdrop: {
    flex: 1,
  ...
  choiceText: { color: C.text, fontSize: 13, fontWeight: "700" },
  preference: {
    minHeight: 50,
    flexDirection: "row",
    alignItems: "center",
  ...
  preferenceText: { color: C.text, fontSize: 13, flex: 1 },
  settingsHint: { color: C.muted, fontSize: 11, lineHeight: 15, marginTop: 6 },
  badge: { color: C.lime, fontSize: 11, fontWeight: "900" },
  detailTitle: { color: C.text, fontSize: 21, fontWeight: "900" },
  detailMessage: { color: C.text, fontSize: 14, lineHeight: 20, marginTop: 10 },
  primary: {
    minHeight: 48,
  ...
  primaryText: { color: "#161e00", fontSize: 12, fontWeight: "900" },
  secondary: {
    minHeight: 44,
