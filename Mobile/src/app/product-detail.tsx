...
const styles = StyleSheet.create({
  ...
  rating: { color: "#d9ff00", fontSize: 9, fontWeight: "900" },
  reviewCount: { color: "#8e998d", fontWeight: "400" },
  stock: { color: "#b9cf00", fontSize: 7, fontWeight: "900" },
  productName: {
    color: "#f1f5eb",
    fontSize: 17,
    lineHeight: 21,
  ...
  productDetail: { color: "#96a095", fontSize: 9, marginTop: 5 },
  priceLine: { flexDirection: "row", alignItems: "center", marginTop: 8 },
  price: { color: "#d9ff00", fontSize: 21, fontWeight: "900" },
  oldPrice: {
    color: "#6d776d",
    fontSize: 9,
  ...
  factLabel: { color: "#7d887d", fontSize: 6, fontWeight: "900" },
  factValueRow: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  factValue: { color: "#eff5e8", fontSize: 16, fontWeight: "900" },
  factDetail: { color: "#9ca79a", fontSize: 7, marginTop: 2 },
  sectionHeading: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  sectionKicker: { color: "#b9cf00", fontSize: 7, fontWeight: "900" },
  memberCard: {
    backgroundColor: "#202521",
    borderRadius: 7,
    paddingHorizontal: 9,
  ...
  benefitCopy: { flex: 1 },
  benefitTitle: { color: "#e8eee3", fontSize: 9, fontWeight: "900" },
  benefitDetail: {
    color: "#899388",
    fontSize: 7,
    marginTop: 3,
  ...
  nutritionLabel: { color: "#d3dbcf", fontSize: 7 },
  nutritionValue: { color: "#eff5e8", fontSize: 7, fontWeight: "900" },
  ...
  reviewScore: { color: "#eff5e8", fontSize: 12, fontWeight: "900" },
  reviewStars: { color: "#d9ff00", fontSize: 10, letterSpacing: 1 },
  reviewCaption: { color: "#8d988c", fontSize: 7, marginLeft: "auto" },
  reviewCard: {
    backgroundColor: "#202521",
    borderRadius: 7,
    padding: 10,
  ...
  avatarText: { color: "#d9ff00", fontSize: 11, fontWeight: "900" },
  reviewIdentity: { flex: 1, marginLeft: 8 },
  reviewer: { color: "#e4ebe0", fontSize: 8, fontWeight: "900" },
  reviewDate: { color: "#7f897e", fontSize: 7, marginTop: 2 },
  reviewText: { color: "#b0baad", fontSize: 8, lineHeight: 12, marginTop: 8 },
  footerNote: {
    color: "#566055",
    fontSize: 7,
    textAlign: "center",
  ...
  quantity: { color: "#f1f5eb", fontSize: 12, fontWeight: "900" },
  buyButton: {
    flex: 1,
    height: 40,
    flexDirection: "row",
  ...
  buyButtonText: { color: "#182000", fontSize: 8, fontWeight: "900" },
});
