...
const styles = StyleSheet.create({
  ...
  securityText: { color: "#d9ff00", fontSize: 6, fontWeight: "900" },
  secureBadge: {
    color: "#aeb9ad",
  ...
  introTitle: { color: "#e7eee4", fontSize: 10, fontWeight: "900" },
  introText: { color: "#9ca79c", fontSize: 7, lineHeight: 10, marginTop: 4 },
  lastChanged: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: "#181d1e",
  ...
  lastChangedText: { color: "#9ba69c", fontSize: 7 },
  field: { marginTop: 12 },
  fieldLabel: {
    color: "#d5e0cd",
    fontSize: 7,
  ...
  input: { flex: 1, color: "#e8efe5", fontSize: 10, paddingVertical: 0 },
  strength: {
    backgroundColor: "#181d1e",
    borderRadius: 6,
    padding: 9,
  ...
  smallLabel: { color: "#9daa9d", fontSize: 6, fontWeight: "900" },
  strengthText: { color: "#d9ff00", fontSize: 6, fontWeight: "900" },
  ...
  rule: { color: "#caff00", fontSize: 7, lineHeight: 14 },
  match: { color: "#48d79e", fontSize: 7, marginTop: 6 },
  sectionLabel: {
    color: "#d5e0cd",
    fontSize: 7,
    fontWeight: "900",
  ...
  optionTitle: { color: "#e5ede2", fontSize: 8, fontWeight: "900" },
  optionDetail: { color: "#89948b", fontSize: 6, marginTop: 3 },
  toggle: {
    width: 32,
    height: 18,
    borderRadius: 10,
  ...
  cancelText: { color: "#e3eae2", fontSize: 8, fontWeight: "900" },
  support: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: "#1b2022",
  ...
  supportTitle: { color: "#bfc9bd", fontSize: 7, fontWeight: "900" },
  supportText: { color: "#89948b", fontSize: 7, marginTop: 3 },
