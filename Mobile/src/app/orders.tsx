...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: "#e9f0e5", fontSize: 11, fontWeight: "900" },
  account: {
    width: 25,
    height: 25,
    borderRadius: 13,
  ...
  searchInput: { flex: 1, color: "#e5ede1", fontSize: 9, paddingVertical: 0 },
  cartIcon: {
    width: 34,
    height: 32,
    borderRadius: 6,
  ...
  cartBadgeText: { color: "#182000", fontSize: 8, fontWeight: "900" },
  ...
  filterText: { color: "#d0dacf", fontSize: 8, fontWeight: "900" },
  ...
  orderId: { color: "#e7eee3", fontSize: 11, fontWeight: "900" },
  muted: { color: "#8d978e" },
  status: {
    fontSize: 7,
    fontWeight: "900",
  ...
  orderDate: { color: "#879289", fontSize: 8, marginTop: 3 },
  cancelReason: {
    color: "#9ba69b",
  ...
  itemName: { color: "#e7eee4", fontSize: 9, fontWeight: "900" },
  itemDetail: { color: "#89958b", fontSize: 8, marginTop: 3 },
  itemPrice: { alignItems: "flex-end", marginLeft: 5 },
  price: { color: "#d9ff00", fontSize: 9, fontWeight: "900" },
  quantity: { color: "#7f8a82", fontSize: 7, marginTop: 3 },
  extra: { color: "#8b968b", fontSize: 7, textAlign: "right", marginTop: 6 },
  totalRow: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
  ...
  totalLabel: { color: "#9ea99f", fontSize: 9 },
  total: { color: "#e9f0e6", fontSize: 13, fontWeight: "900" },
  ...
  secondaryText: { color: "#e8eee4", fontSize: 8, fontWeight: "900" },
  primaryButton: {
    flex: 1,
    height: 30,
    borderRadius: 5,
  ...
  primaryText: { color: "#182000", fontSize: 8, fontWeight: "900" },
  empty: { alignItems: "center", paddingVertical: 55, gap: 10 },
  emptyText: { color: "#aeb9ad", fontSize: 10 },
  footer: {
    color: "#738077",
    fontSize: 7,
    fontWeight: "900",
