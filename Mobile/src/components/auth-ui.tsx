...
export const authStyles = StyleSheet.create({ title: { color: C.text, fontSize: 30, fontWeight: '700', letterSpacing: -0.8 }, description: { color: C.muted, fontSize: 16, lineHeight: 25 }, card: { backgroundColor: C.surface, borderRadius: R.xl, padding: S.md }, row: { flexDirection: 'row', alignItems: 'center' }, kicker: { color: C.lime, fontSize: 12, fontWeight: '700', letterSpacing: 1.5 } });
const s = StyleSheet.create({
  ...
  header: { height: 72, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }, brand: { flexDirection: 'row', alignItems: 'center', gap: 9 }, brandText: { color: C.lime, fontSize: 17, fontWeight: '700', letterSpacing: 2 }, dot: { width: 7, height: 7, borderRadius: 4, backgroundColor: C.lime }, avatar: { width: 34, height: 34, borderRadius: 17, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center' },
  field: { marginBottom: 17 }, label: { color: C.muted, fontSize: 11, fontWeight: '800', letterSpacing: 1, marginBottom: 7 }, inputWrap: { height: 54, backgroundColor: C.surface, borderRadius: 10, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 15, gap: 12 }, input: { flex: 1, color: C.text, fontSize: 15, padding: 0 }, error: { color: C.error, fontSize: 12, marginTop: 5 },
  button: { height: 56, borderRadius: 12, backgroundColor: C.lime, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 12, marginTop: 22 }, disabled: { opacity: .55 }, buttonText: { color: '#283500', fontSize: 14, fontWeight: '800', letterSpacing: 1.2 },
  divider: { flexDirection: 'row', alignItems: 'center', gap: 12, marginVertical: 26 }, line: { height: 1, backgroundColor: '#333538', flex: 1 }, dividerText: { color: C.muted, fontSize: 10, fontWeight: '800', letterSpacing: 1.1 }, socialRow: { flexDirection: 'row', gap: 12 }, social: { flex: 1, height: 52, borderRadius: 12, backgroundColor: C.surface, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 9 }, socialIcon: { fontSize: 22, fontWeight: '800' }, socialText: { color: C.text, fontSize: 14, fontWeight: '700' }, footer: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', marginTop: 32 }, muted: { color: C.muted, fontSize: 14 }, link: { color: C.lime, fontSize: 14, fontWeight: '700', textDecorationLine: 'underline' },
});
