...
await waitFor(`document.body.innerText.includes('HỒ SƠ HỘI VIÊN')`, 'login to profile');
console.log('login: profile');
await send('Page.reload');
await waitFor(`document.body.innerText.includes('HỒ SƠ HỘI VIÊN')`, 'persisted profile');
